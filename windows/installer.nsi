...
!define MUI_FINISHPAGE_RUN "$INSTDIR\NovProg.exe"
...
Section "install"
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APPNAME}" "DisplayIcon" "$\"$INSTDIR\NovProg.exe$\""
	...
	CreateShortCut "$SMPROGRAMS\$StartMenuFolder\${APPNAME}.lnk" "$INSTDIR\NovProg.exe"
